...
- **Plays nicely with [wt](/tools/wt/)** — `hop <name>/<wt-name>` lands you in a worktree.

## Full docs

The full README — grammar, config schema, every subcommand, every gotcha — lives on GitHub:
